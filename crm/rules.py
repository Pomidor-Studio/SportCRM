...
rules.add_perm('event_class', rules.is_authenticated & (is_manager | is_coach))
rules.add_perm('event_class.add', rules.is_authenticated & is_manager)
rules.add_perm('event_class.edit', rules.is_authenticated & is_manager)
rules.add_perm('event_class.delete', rules.is_authenticated & is_manager)
